  ...
  },
  {
    ...
    content: {
      es: {
        ...
        description:
          "Mantenimiento de la red del Data Center, configuración de VLANs e infraestructura de TI para operaciones de telecomunicaciones.",
      },
      en: {
        role: "Network & IT Support Specialist",
        company: "WebHelp · Claro",
        description:
          "Data Center network maintenance, VLAN configuration and IT infrastructure for telecom operations.",
      },
    },
  },
  {
